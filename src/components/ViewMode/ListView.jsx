...
const ListView = ({ photo, title, author, description }) => {
  return (
    <div className='w-[752px] bg-white rounded p-[18px] flex gap-x-3'>
      ...
      <div className='flex flex-col gap-y-3'>
        <button className='view-button bg-[#72D498]'>
          <BsFillInfoCircleFill className='text-white ' />
          Show Details
        </button>
        <button className='view-button bg-[#F0AD4E]'>
